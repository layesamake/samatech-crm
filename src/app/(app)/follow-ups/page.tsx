...
export default function FollowUpsPage() {
  ...
  return <main className="mx-auto max-w-5xl space-y-5 p-4 md:p-8"><header className="flex items-center justify-between"><div><h1 className="text-2xl font-bold hidden md:block">Relances</h1><p className="text-muted-foreground hidden md:block">Les retards sont recalculés à chaque ouverture.</p></div><Link href="/follow-ups/new" className="ml-auto rounded-md bg-blue-600 px-4 py-3 text-white">Nouvelle</Link></header>
