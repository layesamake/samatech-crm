...
function data(): CampaignSegmentationData {
  ...
  return {
    ...
    locations: [{ id: ids.region, name: 'Dakar', normalizedName: 'dakar', level: 'REGION', createdAt: now, updatedAt: now }, { id: ids.city, name: 'Dakar Ville', normalizedName: 'dakar ville', level: 'CITY', parentId: ids.region, createdAt: now, updatedAt: now }, { id: ids.thies, name: 'Thiès', normalizedName: 'thies', level: 'CITY', createdAt: now, updatedAt: now }],
