...
export const TIMELINE_EVENT_TYPES = ['PROSPECT_CREATED', 'PROSPECT_STATUS_CHANGED', 'NOTE_ADDED', 'FOLLOW_UP_CREATED', 'FOLLOW_UP_COMPLETED', 'FOLLOW_UP_RESCHEDULED', 'FOLLOW_UP_CANCELLED', 'WHATSAPP_OPENED', 'PROSPECT_CONVERTED', 'INVOICE_ISSUED', 'INVOICE_CANCELLED', 'PAYMENT_RECORDED', 'PAYMENT_REVERSED', 'CAMPAIGN_PROCESSED', 'OPPORTUNITY_CREATED', 'OPPORTUNITY_STAGE_CHANGED', 'OPPORTUNITY_WON', 'OPPORTUNITY_LOST'] as const;
