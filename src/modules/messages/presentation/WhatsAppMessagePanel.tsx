...
export function WhatsAppMessagePanel({ contactId, normalizedPhone, displayName, iconOnly }: WhatsAppMessagePanelProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent showCloseButton={false} className="p-0 overflow-hidden sm:max-w-lg border-0 bg-transparent shadow-none">
        <div className="rounded-xl border bg-card text-card-foreground shadow-xl overflow-hidden flex flex-col h-full max-h-[85vh]">
          <div className="flex items-center justify-between p-4 border-b bg-[#0B6B2D]/5">
            <div className="flex items-center gap-2">
              ...
              <DialogTitle className="font-semibold text-sm m-0">Envoyer un message WhatsApp</DialogTitle>
            </div>
